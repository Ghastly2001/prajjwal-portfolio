...
const HelpSection = () => {
  ...
  return (
    <div className="bg-[#645577] h-full py-20 lg:py-0 lg:h-[600px] w-full px-8  ">
      <div className="max-w-5xl mx-auto h-full flex items-center justify-center flex-col px-4 sm:px-10">
        <FadeUp>
          <h1 className="font-bold text-3xl w-full text-start lg:text-center text-[#F9F6EF]">
            Passion Meets{" "}
            <span className="font-bold text-[#FF667D]">Recognition</span>
          </h1>
        </FadeUp>
