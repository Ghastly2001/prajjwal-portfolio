...
export const Menu = ({
  ...
  return (
    <nav
      ...
      // className="w-0 text-black"
      className="relative rounded-full border border-transparent dark:border-white/[0.2] bg-black shadow-input flex justify-center  py-6 "
    >
      {children}
    </nav>
  );
